...
public class SHA_256 {
    ...
    //按位填充函数
    private  String fill_zero(String str,int n) {
     ...
     * @param m
     */
    private  void calculate_sha_256(int[] h, int[] k,int [] m) {
     ...
     * @return
     */
    private  long big_sigma1(long x) {
     ...
     * @return
     */
    private  long small_sigma0(int x) {
     ...
     * @return
     */
    private  long small_sigma1(int x) {
     ...
     * @return
     */
    private  int T1(int h,int e,int ch,int w,int k) {
     ...
     * @return
     */
    private  long rightRotate(long x, int n)
    {
        long wei=(0<<n)-1;
     ...
     * @return
     */
    private  long rightShift(int x, int n) {
